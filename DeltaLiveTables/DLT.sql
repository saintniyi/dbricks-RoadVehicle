...
-- Create streaming delta live table for raw_traffic
...
FROM cloud_files(
  'abfss://landing@databricksdevstgs.dfs.core.windows.net/raw_traffic',
  'csv'
)

-- COMMAND ----------

-- Create streaming delta live table for raw_roads
...
FROM cloud_files(
  'abfss://landing@databricksdevstgs.dfs.core.windows.net/raw_roads',
  'csv'
)
...
-- Create streaming delta live table for cleaned traffic from live raw_traffic
...
-- Create streaming delta live table for cleaned roads from live raw_roads
...
-- Create streaming delta live table for gold table by joining cleaned raw traffic and cleaned roads
